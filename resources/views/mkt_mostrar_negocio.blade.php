                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            {!! Form::model($articulo,['files' => 'true', 'method' => 'PATCH','action'=>['MktController@mkt_update_negocio','id'=>$articulo->id_articulos]]) !!}
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div style="display: none;">
                                    <input name="id_negocios" class="form-control" value="<?php echo $articulo->id_negocios; ?>">
