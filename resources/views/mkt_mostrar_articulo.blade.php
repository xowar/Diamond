                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            {!! Form::model($articulo,['files' => 'true', 'method' => 'PATCH','action'=>['MktController@mkt_update_proyectos','id'=>$articulo->id_articulos]]) !!}
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label>Costo</label>
                                        <input name="costo" class="form-control" value="<?php echo $articulo->costo; ?>" required onkeypress="return only_num(event)" maxlength="20">
                                    </div> 
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div style="display: none;">
                                    <input name="id_proyectos" class="form-control" value="<?php echo $articulo->id_proyectos; ?>">
