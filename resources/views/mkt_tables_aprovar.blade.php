...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">NOMBRE: <?php foreach ($proyectos as $proyecto) {
                                                echo $proyecto->nombre_inicial; 
                                                } ?></h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        {!! Form::open(['url'=>'home/mkt/buscar_por_proyecto/save_articulo', 'method'=>'POST']) !!}
                            <div class="row">
                                <div class="col-lg-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <input name="id_proyectos" class="form-control" value="<?php echo $proyecto->id_proyecto; ?>">
                                        <?php } ?>
                                    </div>
                                </div>  
                            </div>
                        ...
                        {!! Form::close() !!}
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-group">
                                                <a class="btn btn-primary" href="{{URL::to('home/mkt/buscar_por_proyecto/proceso', array($articulo1->id_articulos, $articulo1->id_proyectos))}}">Por Autorizar</a>
                                            </div>
                                        </div>
                                         ...
                                         <div id="<?php echo "myModal".$contador1; ?>" class="modal" style="display: none;">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer ">
                                                <div class="text-center">
                                                    <a class="btn btn-success" href="{{URL::to('home/mkt/buscar_por_proyecto/mostrar', array($articulo1->id_articulos))}}">EDITAR</a>
                                                    <a class="btn btn-danger" href="{{URL::to('home/mkt/buscar_por_proyecto/eliminar_articulo', array($articulo1->id_articulos, $articulo1->id_proyectos))}}">ELIMINAR</a>
                                                </div>
                                    ...
                                    foreach ($articulos2 as $articulo2) { ?>
                                        ...
                                        <div id="<?php echo "myModall".$contador2; ?>" class="modal" style="display: none;">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-footer ">
                                                <div class="text-center">
                                                    <a class="btn btn-success" href="{{URL::to('home/mkt/buscar_por_proyecto/mostrar', array($articulo2->id_articulos))}}">EDITAR</a>
                                                    <a class="btn btn-danger" href="{{URL::to('home/mkt/buscar_por_proyecto/eliminar_articulo', array($articulo2->id_articulos, $articulo2->id_proyectos))}}">ELIMINAR</a>
                                                </div>
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-group">
                                                <a class="btn btn-primary" href="{{URL::to('home/mkt/buscar_por_proyecto/por_autorizar', array($articulo2->id_articulos))}}">Autorizar</a>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1 text-right">
                                    <?php foreach ($proyectos as $proyecto) {?>
                                        <label>$ <?php echo number_format($proyecto->precio_cormecializacion); ?></label>
                                    <?php } ?>    
                                </div>
                            </div>
                            <div class="row">
