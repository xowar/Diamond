                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody style="text-align: center;">
                                    <?php 
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                                <a class="btn btn-primary" href="{{URL::to('home/table_users/edit', array($user->id_employees))}}">Editar</a>
                                                <a class="btn btn-danger" href="{{URL::to('home/table_users/destroy', array($user->id_employees))}}">Eliminar</a>
                                            </td>
