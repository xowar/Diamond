                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" id="elementHidde1">
                            <div class="row">
                            {!! Form::open(['url'=>'home/mkt/buscar_por_propiedad/por_autorizar_guardar_propiedad', 'method'=>'POST']) !!}
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group text-center" style="display: none;">
                                        <?php foreach ($articulos as $articulo) { ?>
                                            ...
                                            <input type="" name="id_propiedad" value="<?php echo $articulo->id_propiedad; ?>">
                                        <?php } ?>
                                    </div>
